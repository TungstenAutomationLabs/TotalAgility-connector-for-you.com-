...
👉 The imported collection expects the API key in a Postman environment variable called `{{you.com api key}}`. Set this under the **Authorization** tab of the collection.
